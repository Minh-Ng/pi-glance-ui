import { activityPhaseForTool, formatDuration, getToolErrorMessage, groupLabel, groupLabelColor, renderBlockHeading, stripVerticalPadding, summarize, toolAction, toolCategory } from "../format.js";
